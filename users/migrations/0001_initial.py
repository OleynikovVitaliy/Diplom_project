    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invite_code', models.CharField(blank=True, max_length=6, null=True, unique=True, verbose_name='Invite код')),
                ('referral_code', models.CharField(blank=True, max_length=6, null=True, verbose_name='Код реферала')),
                ...
                ('referrals', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Рефералы')),
